    ...
    <div class="grid_16 blog-list margin">
		...
		<div class="p_table">
			...
			<!-- column style 1 -->
			<div class="column_1" style="width:216px;">
				<!-- ribbon (optional) -->
			...
			<!-- column style 2 -->
			<div class="column_2" style="width:216px;">
				<!-- ribbon (optional) -->
				<!--<div class="column_ribbon ribbon_style1_new"></div>-->
				<!-- /ribbon -->
			...
			<!-- column style 3 -->
			<div class="column_4" style="width:216px;">
				<!-- ribbon (optional) -->
				<!--<div class="column_ribbon ribbon_style1_new"></div>-->
				<!-- /ribbon -->
    ...
    <div id="advert" class="grid_16 advert">
        ...
        <div class="margin3 fright"><a href="/users/demo_login" target="_blank" class="minibutton">Live Demo</a></div>
    </div>
    <!-- Advert End -->
