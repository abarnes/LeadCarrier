...
-------------------------------------------------------->
	<div id="mws-login-bg">
        <div id="mws-login-wrapper">
		    ...
		    <?php echo $this->Form->create('User', array('action' => 'lg','class'=>'mws-form')); ?>
				...
				<?php echo $this->Form->input('username', array( 'label' => '','placeholder'=>'username','value'=>$name,'class'=>'mws-login-username mws-textinput')); ?>
                            </div>
                        </div>
                        <div class="mws-form-row">
                            <div class="mws-form-item large">
				<?php echo $this->Form->input('password', array('label'=>'','placeholder'=>'password','class'=>'mws-login-password mws-textinput')); ?>
                        ...
                        <div class="mws-form-row mws-inset">
                            <ul class="mws-form-list inline">
                                ...
                                <li><?php echo $this->Form->checkbox('remember',array('label'=>'Remember Me','checked'=>true)); ?><label>Remember Me</label></li>
                            </ul>
                        </div>
                        <div class="mws-form-row">
