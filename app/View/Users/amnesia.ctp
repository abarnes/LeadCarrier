...
-------------------------------------------------------->
	...
	<div id="mws-login-bg">
        <div id="mws-login-wrapper">
		    ...
		    <?php echo $this->Form->create('User', array('action' => 'amnesia','class'=>'mws-form')); ?>
				...
				<p style="color:white;">You will receive an email with your username and a link to reset your password.</p>
				<?php echo $this->Form->input('email', array( 'label' => '','placeholder'=>'email address','class'=>'mws-login-username mws-textinput')); ?>
                            </div>
                        </div>
                        <div class="mws-form-row">
