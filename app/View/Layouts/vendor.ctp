	...
	<div id="mws-header" class="clearfix">
		...
		<!--<div id="mws-user-notif" class="mws-dropdown-menu">
            ...
            <div id="mws-user-message" class="mws-dropdown-menu">
                ...
                <?php if ($count!=0) { echo '<span class="mws-dropdown-notif">'.$count.'</span>'; } ?>
                <div class="mws-dropdown-box">
                	<div class="mws-dropdown-content">
			   ...
			   <li class="unread">
                            	<a href="/bills">
                                    <span class="sender">Unpaid Bill</span>
                                    <span class="message">
                                        A new bill has been generated.
                                    </span>
                                    <span class="time">
                                        <?php echo $u['Bill']['week_start'].'-'.$u['Bill']['week_end']; ?>
                                    </span>
                                </a>
                            </li>
			<?php } ?>
            ...
            <div id="mws-user-info" class="mws-inset">
            	<div id="mws-user-photo">
                	<img src="/css/icons/32/user_red.png" alt="User Photo" />
                </div>
